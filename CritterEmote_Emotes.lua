...
BACKPACK = {
	default = { " Do you want some help with that?", },
...
Random = {
  ...
  default_Silly = {
		...
		"twerks.",
		"shakes it in the air like they just don't care.",
...
Target = {
	default = {
		...
		"barks at %t",
		"is too bashful to get %t's attention.",
		"beckons %t over.",
		"begs %t. How pathetic.",
		...
		"nods at %t.",
		"picks your nose to show it to %t.",
		"takes one look at %t and panics.",
		"gently pats %t.",
